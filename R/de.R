...
make_sticky_plots <- function(cpm_vec, label_vec, ind_vec, colour_vec) {
    
  ggplot_input <- data.frame("cpm" = cpm_vec, "label" = label_vec, "ind" = ind_vec)
  ggplot_input$label_int <- as.numeric(as.factor(ggplot_input$label))
